...
> Généré: `2026-07-15T04:47:33Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 215 |
| PnL net | 9.9459 USDT | -2.4376 USDT |
| SKIP total | 1492 | 1046 |
| duo_wait | 169 (11.3% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **166** (98.2% des duo_wait)
- `no_state` — **3** (1.8% des duo_wait)
...
- `shock_inversion_stop` — 168 trades
- `fluid_exit_inversion` — 25 trades
- `fluid_exit_brake` — 22 trades

- Sorties `shock_inversion_stop` : **168**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (1010 SKIP)

Même si le duo était parfait, 67.7% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
