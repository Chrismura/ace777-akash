...
> Généré: `2026-07-22T11:42:26Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 9 | 66 |
| PnL net | -10.5614 USDT | 0.1266 USDT |
| SKIP total | 1520 | 1340 |
...
- `shock_inversion_stop` — 48 trades
- `fluid_exit_inversion` — 12 trades
- `fluid_exit_brake` — 4 trades
- `stop_loss` — 1 trades
- `trailing_stop` — 1 trades

- Sorties `shock_inversion_stop` : **48**
- Sorties `stop_loss` : **1**
...
### 3. radar_block en amont (1130 SKIP)

Même si le duo était parfait, 74.3% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
