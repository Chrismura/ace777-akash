...
> Généré: `2026-08-14T09:29:21Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 3 | 23 |
| PnL net | 0.4620 USDT | 0.1764 USDT |
| SKIP total | 200 | 191 |
| duo_wait | 23 (11.5% des SKIP ALPHA) | 0 |
...
### 3. radar_block en amont (158 SKIP)

Même si le duo était parfait, 79.0% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
