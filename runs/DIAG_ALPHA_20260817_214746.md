...
> Généré: `2026-08-17T21:47:46Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 6 | 10 |
| PnL net | 0.3891 USDT | 0.1222 USDT |
| SKIP total | 89 | 83 |
| duo_wait | 7 (7.9% des SKIP ALPHA) | 0 |
...
### 3. radar_block en amont (73 SKIP)

Même si le duo était parfait, 82.0% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
