...
> Généré: `2026-07-10T21:51:08Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 3 |
| PnL net | 0.0000 USDT | 0.0074 USDT |
| SKIP total | 17 | 9 |
| duo_wait | 3 (17.6% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **3** (100.0% des duo_wait)
...
### 3. radar_block en amont (13 SKIP)

Même si le duo était parfait, 76.5% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
