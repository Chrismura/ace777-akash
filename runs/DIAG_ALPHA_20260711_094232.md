...
> Généré: `2026-07-11T09:42:32Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 11 | 21 |
| PnL net | 3.4461 USDT | -0.5628 USDT |
| SKIP total | 149 | 141 |
| duo_wait | 13 (8.7% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **12** (92.3% des duo_wait)
- `no_state` — **1** (7.7% des duo_wait)
...
Même si le duo était parfait, 73.8% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
