...
> Généré: `2026-07-09T19:09:51Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 3 |
| PnL net | -0.8256 USDT | -0.0307 USDT |
| SKIP total | 50 | 71 |
| duo_wait | 2 (4.0% des SKIP ALPHA) | 0 |
...
Même si le duo était parfait, 86.0% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
