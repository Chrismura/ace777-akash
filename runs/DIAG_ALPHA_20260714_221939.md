...
> Généré: `2026-07-14T22:19:39Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 58 |
| PnL net | 1.3856 USDT | 0.5679 USDT |
| SKIP total | 485 | 381 |
| duo_wait | 39 (8.0% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **39** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 56 trades
- `fluid_exit_inversion` — 2 trades

- Sorties `shock_inversion_stop` : **56**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (349 SKIP)

Même si le duo était parfait, 72.0% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
