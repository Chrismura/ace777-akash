...
`WHY_ARRET=unknown | ran_min=41.0 | vs_planned_min=+5304.7 | timing=early_stop`

- Généré : `2026-08-16T18:22:23Z`
- Fenêtre depuis : `2026-08-16T17:41:20Z`
- Fin process : `2026-08-16T18:22:20Z`
- Meta start/end : `2026-08-16T17:41:20Z` → `2026-08-20T10:47:01Z`
...
- Issues duo (302) — scout/hunter désynchro.
...
| E-DUO | 302 | no_trigger / stale duo |
| E-SPREAD | 665 | spread trop large |
| I-HUNTER | 0 | STORM_HUNTER arm (info) |

## PnL fills (fenêtre)

- ALPHA : fills=0 pnl=+0.0000 exits={}
- BETA : fills=3 pnl=-0.1481 exits={'fluid_exit_inversion': 2, 'shock_inversion_stop': 1}
- **TOTAL** : -0.1481

## Derniers PROCESS_DIE / EXIT

- `[ALPHA_X13_BURST13] 2026-08-16T18:21:54Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_0 rc=0`
- `[BETA_X5] 2026-08-16T18:22:20Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_0 rc=0`
- `2026-08-16T18:21:54Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_0 rc=0`
- `2026-08-16T18:22:20Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_0 rc=0`
