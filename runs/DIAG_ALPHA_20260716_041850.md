...
> Généré: `2026-07-16T04:18:50Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 6 | 126 |
| PnL net | 3.1963 USDT | 2.1541 USDT |
| SKIP total | 978 | 740 |
| duo_wait | 99 (10.1% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **98** (99.0% des duo_wait)
- `no_state` — **1** (1.0% des duo_wait)
...
- `shock_inversion_stop` — 101 trades
- `fluid_exit_inversion` — 15 trades
- `fluid_exit_brake` — 10 trades

- Sorties `shock_inversion_stop` : **101**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (670 SKIP)

Même si le duo était parfait, 68.5% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
