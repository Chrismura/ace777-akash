...
> Généré: `2026-07-14T14:46:33Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 7 | 125 |
| PnL net | 35.4865 USDT | -0.2479 USDT |
| SKIP total | 1165 | 813 |
| duo_wait | 115 (9.9% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **97** (84.3% des duo_wait)
- `stale_state` — **16** (13.9% des duo_wait)
- `no_state` — **2** (1.7% des duo_wait)
...
- `shock_inversion_stop` — 106 trades
- `fluid_exit_inversion` — 16 trades
- `fluid_exit_brake` — 2 trades
- `shock_exit_10bps` — 1 trades

- Sorties `shock_inversion_stop` : **107**
- Sorties `stop_loss` : **0**
...
Observé : **16** fois (13.9% des duo_wait).

### 3. radar_block en amont (864 SKIP)

Même si le duo était parfait, 74.2% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
