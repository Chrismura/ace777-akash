...
> Généré: `2026-07-10T15:57:09Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 4 |
| PnL net | 0.0000 USDT | 0.2045 USDT |
| SKIP total | 34 | 27 |
| duo_wait | 5 (14.7% des SKIP ALPHA) | 0 |
...
- `no_state` — **3** (60.0% des duo_wait)
- `no_trigger` — **2** (40.0% des duo_wait)
