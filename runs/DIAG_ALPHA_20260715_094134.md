...
> Généré: `2026-07-15T09:41:34Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 29 |
| PnL net | -6.3398 USDT | -0.2500 USDT |
| SKIP total | 289 | 247 |
| duo_wait | 31 (10.7% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **30** (96.8% des duo_wait)
- `no_state` — **1** (3.2% des duo_wait)
...
- `shock_inversion_stop` — 26 trades
- `fluid_exit_brake` — 3 trades

- Sorties `shock_inversion_stop` : **26**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (218 SKIP)
