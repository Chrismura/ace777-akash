...
> Généré: `2026-08-19T01:42:58Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 61 | 226 |
| PnL net | 0.1371 USDT | 3.4574 USDT |
| SKIP total | 1815 | 1499 |
| duo_wait | 213 (11.7% des SKIP ALPHA) | 0 |
...
- `unknown` — **213** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 225 trades
- `trailing_stop` — 1 trades

- Sorties `shock_inversion_stop` : **225**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (1176 SKIP)

Même si le duo était parfait, 64.8% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
