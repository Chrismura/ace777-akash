...
> Généré: `2026-07-30T20:42:58Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 1 | 33 |
| PnL net | -0.0804 USDT | -0.5433 USDT |
| SKIP total | 356 | 293 |
| duo_wait | 16 (4.5% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **15** (93.8% des duo_wait)
- `no_state` — **1** (6.2% des duo_wait)
...
### 3. radar_block en amont (287 SKIP)

Même si le duo était parfait, 80.6% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
