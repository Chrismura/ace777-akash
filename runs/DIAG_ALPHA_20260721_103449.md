...
> Généré: `2026-07-21T10:34:49Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 39 |
| PnL net | 0.1057 USDT | -0.3664 USDT |
| SKIP total | 1006 | 480 |
| duo_wait | 45 (4.5% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **24** (53.3% des duo_wait)
- `stale_state` — **20** (44.4% des duo_wait)
- `no_state` — **1** (2.2% des duo_wait)
...
- `shock_inversion_stop` — 24 trades
- `fluid_exit_inversion` — 9 trades
- `trailing_stop` — 4 trades
- `stop_loss` — 1 trades
- `fluid_exit_brake` — 1 trades

- Sorties `shock_inversion_stop` : **24**
- Sorties `stop_loss` : **1**
...
Observé : **20** fois (44.4% des duo_wait).

### 3. radar_block en amont (759 SKIP)

Même si le duo était parfait, 75.4% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
