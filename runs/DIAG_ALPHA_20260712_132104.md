...
> Généré: `2026-07-12T13:21:05Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 4 |
| PnL net | 0.0000 USDT | 0.0474 USDT |
| SKIP total | 37 | 35 |
| duo_wait | 5 (13.5% des SKIP ALPHA) | 0 |
...
### 3. radar_block en amont (24 SKIP)

Même si le duo était parfait, 64.9% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
