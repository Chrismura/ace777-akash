# DIAGNOSTIC ALPHA — MASTER_VORTEX_V2_COLLAB_4H_20260710_105208

> Généré: `2026-07-10T11:18:56Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 1 | 4 |
| PnL net | -2.9294 USDT | -0.1023 USDT |
| SKIP total | 61 | 52 |
| duo_wait | 4 (6.6% des SKIP ALPHA) | 0 |
...
- `no_state` — **3** (75.0% des duo_wait)
- `no_trigger` — **1** (25.0% des duo_wait)
...
Même si le duo était parfait, 86.9% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
