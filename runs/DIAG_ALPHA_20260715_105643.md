...
> Généré: `2026-07-15T10:56:43Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 1 | 25 |
| PnL net | -0.0261 USDT | -1.7119 USDT |
| SKIP total | 195 | 156 |
| duo_wait | 20 (10.3% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **19** (95.0% des duo_wait)
- `no_state` — **1** (5.0% des duo_wait)
...
### 3. radar_block en amont (142 SKIP)

Même si le duo était parfait, 72.8% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
