...
> Généré: `2026-07-09T22:40:52Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 9 |
| PnL net | -1.0964 USDT | 0.7684 USDT |
| SKIP total | 197 | 171 |
| duo_wait | 10 (5.1% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **9** (90.0% des duo_wait)
- `no_state` — **1** (10.0% des duo_wait)
...
### 3. radar_block en amont (77 SKIP)

Même si le duo était parfait, 39.1% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
