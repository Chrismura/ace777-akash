# DIAGNOSTIC ALPHA — MASTER_BASE_V8_5_IMPACT_C2

> Généré: `2026-07-08T16:04:57Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 21 | 16 |
| PnL net | -3.9473 USDT | -0.5816 USDT |
| SKIP total | 814 | 846 |
| duo_wait | 56 (6.9% des SKIP ALPHA) | 0 |
...
### 3. radar_block en amont (606 SKIP)
