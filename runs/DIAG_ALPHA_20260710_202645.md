...
> Généré: `2026-07-10T20:26:45Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 34 |
| PnL net | 0.0000 USDT | 0.8783 USDT |
| SKIP total | 38 | 216 |
| duo_wait | 1 (2.6% des SKIP ALPHA) | 0 |
...
Même si le duo était parfait, 84.2% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
