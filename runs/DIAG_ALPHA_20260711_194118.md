...
> Généré: `2026-07-11T19:41:18Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 3 | 22 |
| PnL net | -0.9265 USDT | 0.1031 USDT |
| SKIP total | 158 | 152 |
| duo_wait | 15 (9.5% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **15** (100.0% des duo_wait)
...
### 3. radar_block en amont (117 SKIP)
