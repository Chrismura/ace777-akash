...
> Généré: `2026-07-12T16:57:55Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 3 | 6 |
| PnL net | -2.2028 USDT | 0.1963 USDT |
| SKIP total | 30 | 30 |
| duo_wait | 2 (6.7% des SKIP ALPHA) | 0 |
...
Même si le duo était parfait, 90.0% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
