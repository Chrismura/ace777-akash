...
> Généré: `2026-07-10T10:24:43Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 4 | 8 |
| PnL net | 2.2473 USDT | -0.0102 USDT |
| SKIP total | 83 | 80 |
| duo_wait | 6 (7.2% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **5** (83.3% des duo_wait)
- `no_state` — **1** (16.7% des duo_wait)
...
### 3. radar_block en amont (59 SKIP)
