...
> Généré: `2026-07-17T18:37:20Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 4 | 71 |
| PnL net | 0.9382 USDT | 1.6416 USDT |
| SKIP total | 537 | 399 |
| duo_wait | 65 (12.1% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **59** (90.8% des duo_wait)
- `no_state` — **6** (9.2% des duo_wait)
...
### 3. radar_block en amont (362 SKIP)

Même si le duo était parfait, 67.4% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
