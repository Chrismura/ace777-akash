...
**Période:** 2026-07-12T12:22:56Z → 2026-07-12T12:23:11Z (0h00m)
...
**Généré:** 2026-07-12T12:25:21Z UTC
**Filtre session:** `ts >= 2026-07-12T12:22:36Z` (lignes CSV antérieures exclues)
...
| Métrique | Valeur |
|----------|--------|
| **PNL BETA** | **+0.0015 USDT** |
| **PNL ALPHA** | **+0.0000 USDT** |
| **PNL SESSION TOTAL** | **+0.0015 USDT** |
| Statut | `POSITIF` |
...
| Flat (0) | 0 |
| Win rate | **100.0%** |
| Gains totaux | +0.0015 USDT |
| Pertes totales | +0.0000 USDT |
| **PNL net** | **+0.0015 USDT** |
| BPS moyen | 0.02 |

**Meilleur trade:** +0.0015 USDT
