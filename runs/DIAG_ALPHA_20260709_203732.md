...
> Généré: `2026-07-09T20:37:32Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 6 | 37 |
| PnL net | 1.3080 USDT | 0.6738 USDT |
| SKIP total | 59 | 327 |
...
### 3. radar_block en amont (50 SKIP)

Même si le duo était parfait, 84.7% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
