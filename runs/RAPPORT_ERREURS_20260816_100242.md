...
`WHY_ARRET=unknown | ran_min=120.1 | vs_planned_min=-0.1 | timing=near_timer`

- Généré : `2026-08-16T10:02:42Z`
- Fenêtre depuis : `2026-08-16T08:02:31Z`
- Fin process : `2026-08-16T10:02:39Z`
- Meta start/end : `2026-08-16T08:02:31Z` → `2026-08-16T10:02:31Z`
...
- Issues duo (1319) — scout/hunter désynchro.
...
| E-DUO | 1319 | no_trigger / stale duo |
| E-SPREAD | 1689 | spread trop large |
| I-HUNTER | 0 | STORM_HUNTER arm (info) |

## PnL fills (fenêtre)

- ALPHA : fills=3 pnl=-1.0421 exits={'fluid_exit_brake': 2, 'shock_inversion_stop': 1}
- BETA : fills=23 pnl=+0.0565 exits={'shock_inversion_stop': 20, 'fluid_exit_inversion': 2, 'fluid_exit_brake': 1}
- **TOTAL** : -0.9856

## Derniers PROCESS_DIE / EXIT

- `[ALPHA_X13_BURST13] 2026-08-16T10:02:32Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_0 rc=0`
- `[BETA_X5] 2026-08-16T10:02:39Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_0 rc=0`
- `2026-08-16T10:02:32Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_0 rc=0`
- `2026-08-16T10:02:39Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_0 rc=0`
