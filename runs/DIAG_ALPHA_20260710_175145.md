...
> Généré: `2026-07-10T17:51:46Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 9 | 23 |
| PnL net | 2.5589 USDT | -0.2042 USDT |
| SKIP total | 172 | 185 |
| duo_wait | 11 (6.4% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **10** (90.9% des duo_wait)
...
- `shock_inversion_stop` — 22 trades
- `fluid_exit_inversion` — 1 trades

- Sorties `shock_inversion_stop` : **22**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (131 SKIP)

Même si le duo était parfait, 76.2% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
