...
> Généré: `2026-07-12T11:57:32Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 1 |
| PnL net | 0.0000 USDT | -0.0186 USDT |
| SKIP total | 31 | 30 |
| duo_wait | 1 (3.2% des SKIP ALPHA) | 0 |
...
### 3. radar_block en amont (29 SKIP)

Même si le duo était parfait, 93.5% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
