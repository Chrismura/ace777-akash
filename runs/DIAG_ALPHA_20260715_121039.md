...
> Généré: `2026-07-15T12:10:39Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 36 |
| PnL net | -0.5624 USDT | -0.1475 USDT |
| SKIP total | 322 | 268 |
| duo_wait | 23 (7.1% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **23** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 31 trades
- `fluid_exit_brake` — 5 trades

- Sorties `shock_inversion_stop` : **31**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (240 SKIP)

Même si le duo était parfait, 74.5% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
