...
> Généré: `2026-07-10T10:09:29Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 15 | 26 |
| PnL net | 0.1022 USDT | -0.3700 USDT |
| SKIP total | 182 | 167 |
| duo_wait | 6 (3.3% des SKIP ALPHA) | 0 |
...
- `shock_inversion_stop` — 23 trades
- `fluid_exit_inversion` — 3 trades

- Sorties `shock_inversion_stop` : **23**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (141 SKIP)
