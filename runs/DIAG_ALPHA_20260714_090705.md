# DIAGNOSTIC ALPHA — NUAGE_4H00

> Généré: `2026-07-14T09:07:05Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 90 |
| PnL net | 0.0000 USDT | 2.6552 USDT |
| SKIP total | 248 | 660 |
| duo_wait | 38 (15.3% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **38** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 76 trades
- `fluid_exit_inversion` — 9 trades
- `fluid_exit_brake` — 5 trades

- Sorties `shock_inversion_stop` : **76**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (179 SKIP)

Même si le duo était parfait, 72.2% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
