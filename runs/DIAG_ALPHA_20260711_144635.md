...
> Généré: `2026-07-11T14:46:35Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 8 | 20 |
| PnL net | 0.2383 USDT | -0.1783 USDT |
| SKIP total | 76 | 56 |
| duo_wait | 8 (10.5% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **6** (75.0% des duo_wait)
- `no_state` — **2** (25.0% des duo_wait)
...
### 3. radar_block en amont (57 SKIP)
