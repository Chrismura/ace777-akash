...
`WHY_ARRET=unknown | ran_min=16.5 | vs_planned_min=+182.8 | timing=early_stop`

- Généré : `2026-08-13T17:34:22Z`
- Fenêtre depuis : `2026-08-13T17:17:51Z`
- Fin process : `2026-08-13T17:34:20Z`
- Meta start/end : `2026-08-13T17:17:51Z` → `2026-08-13T20:37:05Z`
...
| E-SPREAD | 706 | spread trop large |
| I-HUNTER | 0 | STORM_HUNTER arm (info) |

## PnL fills (fenêtre)

- ALPHA : fills=9 pnl=+3.3333 exits={'shock_inversion_stop': 9}
- BETA : fills=12 pnl=-0.0869 exits={'shock_inversion_stop': 10, 'fluid_exit_brake': 2}
- **TOTAL** : +3.2463

## Derniers PROCESS_DIE / EXIT

- `[ALPHA_X13_BURST13] 2026-08-13T17:30:28Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_1 rc=1`
- `[BETA_X5] 2026-08-13T17:34:20Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_1 rc=1`
- `2026-08-13T17:30:28Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_1 rc=1`
