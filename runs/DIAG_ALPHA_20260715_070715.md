...
> Généré: `2026-07-15T07:07:15Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 1 | 61 |
| PnL net | -4.8919 USDT | 0.7210 USDT |
| SKIP total | 392 | 265 |
| duo_wait | 42 (10.7% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **40** (95.2% des duo_wait)
- `no_state` — **2** (4.8% des duo_wait)
...
- `shock_inversion_stop` — 40 trades
- `fluid_exit_inversion` — 19 trades
- `fluid_exit_brake` — 2 trades

- Sorties `shock_inversion_stop` : **40**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (271 SKIP)
