...
> Généré: `2026-07-10T15:25:40Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 15 | 27 |
| PnL net | 8.6316 USDT | 1.0032 USDT |
| SKIP total | 115 | 79 |
| duo_wait | 15 (13.0% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **13** (86.7% des duo_wait)
- `no_state` — **1** (6.7% des duo_wait)
- `stale_state` — **1** (6.7% des duo_wait)
...
Observé : **1** fois (6.7% des duo_wait).
