...
> Généré: `2026-07-22T14:32:40Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 5 | 51 |
| PnL net | 0.1696 USDT | -0.7306 USDT |
| SKIP total | 1008 | 862 |
...
- `shock_inversion_stop` — 36 trades
- `fluid_exit_inversion` — 9 trades
- `trailing_stop` — 3 trades
- `fluid_exit_brake` — 1 trades
- `shock_exit_10bps` — 1 trades

- Sorties `shock_inversion_stop` : **37**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (750 SKIP)
