...
> Généré: `2026-07-09T16:59:03Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 6 | 233 |
| PnL net | 1.6356 USDT | 0.4124 USDT |
| SKIP total | 134 | 1307 |
| duo_wait | 12 (9.0% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **12** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 199 trades
- `fluid_exit_inversion` — 30 trades
- `shock_exit_10bps` — 2 trades
- `fluid_exit_brake` — 1 trades
- `kill_switch` — 1 trades

- Sorties `shock_inversion_stop` : **201**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (101 SKIP)
