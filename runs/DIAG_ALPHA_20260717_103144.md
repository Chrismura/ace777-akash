...
> Généré: `2026-07-17T10:31:44Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 5 | 72 |
| PnL net | 2.1078 USDT | -2.1654 USDT |
| SKIP total | 386 | 258 |
| duo_wait | 26 (6.7% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **26** (100.0% des duo_wait)
...
Même si le duo était parfait, 68.7% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
