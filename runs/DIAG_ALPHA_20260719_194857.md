...
> Généré: `2026-07-19T19:48:57Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 1 | 108 |
| PnL net | -6.2972 USDT | 0.6500 USDT |
| SKIP total | 1030 | 817 |
| duo_wait | 88 (8.5% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **88** (100.0% des duo_wait)
...
### 3. radar_block en amont (793 SKIP)

Même si le duo était parfait, 77.0% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
