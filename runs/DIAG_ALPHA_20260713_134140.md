...
> Généré: `2026-07-13T13:41:40Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 2 |
| PnL net | 0.0000 USDT | 0.1864 USDT |
| SKIP total | 33 | 33 |
| duo_wait | 3 (9.1% des SKIP ALPHA) | 0 |
...
Même si le duo était parfait, 78.8% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
