...
> Généré: `2026-07-10T08:37:06Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 15 | 17 |
| PnL net | 26.8768 USDT | -1.0258 USDT |
| SKIP total | 137 | 109 |
| duo_wait | 13 (9.5% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **9** (69.2% des duo_wait)
- `no_state` — **3** (23.1% des duo_wait)
- `stale_state` — **1** (7.7% des duo_wait)
...
- `shock_inversion_stop` — 11 trades
...
Observé : **1** fois (7.7% des duo_wait).

### 3. radar_block en amont (103 SKIP)

Même si le duo était parfait, 75.2% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
