...
> Généré: `2026-07-12T08:43:13Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 7 |
| PnL net | 0.0000 USDT | 0.0924 USDT |
| SKIP total | 69 | 54 |
| duo_wait | 6 (8.7% des SKIP ALPHA) | 0 |
...
- `no_state` — **3** (50.0% des duo_wait)
- `no_trigger` — **3** (50.0% des duo_wait)
...
Même si le duo était parfait, 79.7% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
