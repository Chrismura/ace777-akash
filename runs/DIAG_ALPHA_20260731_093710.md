...
> Généré: `2026-07-31T09:37:11Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 47 |
| PnL net | -3.3345 USDT | 1.5350 USDT |
| SKIP total | 991 | 886 |
...
- `shock_inversion_stop` — 25 trades
- `fluid_exit_inversion` — 14 trades
- `fluid_exit_brake` — 8 trades

- Sorties `shock_inversion_stop` : **25**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (718 SKIP)
