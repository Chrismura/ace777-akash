...
> Généré: `2026-07-09T01:31:27Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 20 | 41 |
| PnL net | -1.3616 USDT | 1.5790 USDT |
| SKIP total | 1840 | 1820 |
| duo_wait | 160 (8.7% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **160** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 38 trades
- `fluid_exit_inversion` — 2 trades
- `fluid_exit_brake` — 1 trades

- Sorties `shock_inversion_stop` : **38**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (1440 SKIP)

Même si le duo était parfait, 78.3% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
