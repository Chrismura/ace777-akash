...
> Généré: `2026-07-17T06:45:27Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 1 | 65 |
| PnL net | -0.6308 USDT | 0.6607 USDT |
| SKIP total | 406 | 275 |
| duo_wait | 54 (13.3% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **54** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 50 trades
- `fluid_exit_inversion` — 10 trades
- `fluid_exit_brake` — 5 trades

- Sorties `shock_inversion_stop` : **50**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (280 SKIP)

Même si le duo était parfait, 69.0% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
