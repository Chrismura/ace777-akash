...
> Généré: `2026-08-13T12:22:11Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 90 |
| PnL net | 0.0000 USDT | 0.5060 USDT |
| SKIP total | 185 | 1493 |
| duo_wait | 4 (2.2% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **3** (75.0% des duo_wait)
...
### 3. radar_block en amont (181 SKIP)

Même si le duo était parfait, 97.8% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
