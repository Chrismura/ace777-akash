# DIAGNOSTIC ALPHA — VALIDATION_VOIE_A_PACK_A

> Généré: `2026-07-29T20:02:35Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 28 | 253 |
| PnL net | 18.2349 USDT | 1.5526 USDT |
| SKIP total | 506 | 1108 |
| duo_wait | 80 (15.8% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **80** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 208 trades
- `fluid_exit_inversion` — 36 trades
- `fluid_exit_brake` — 8 trades
- `stop_loss` — 1 trades

- Sorties `shock_inversion_stop` : **208**
- Sorties `stop_loss` : **1**
...
### 3. radar_block en amont (373 SKIP)

Même si le duo était parfait, 73.7% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
