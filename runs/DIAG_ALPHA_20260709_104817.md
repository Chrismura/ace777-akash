...
> Généré: `2026-07-09T10:48:17Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 57 | 152 |
| PnL net | 10.8490 USDT | 2.2534 USDT |
| SKIP total | 1705 | 1511 |
| duo_wait | 187 (11.0% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **187** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 133 trades
- `fluid_exit_inversion` — 16 trades
- `fluid_exit_brake` — 3 trades

- Sorties `shock_inversion_stop` : **133**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (1251 SKIP)

Même si le duo était parfait, 73.4% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
