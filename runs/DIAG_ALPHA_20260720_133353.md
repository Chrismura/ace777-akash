...
> Généré: `2026-07-20T13:33:53Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 120 |
| PnL net | -0.7233 USDT | -3.2210 USDT |
| SKIP total | 1085 | 598 |
| duo_wait | 110 (10.1% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **71** (64.5% des duo_wait)
- `stale_state` — **35** (31.8% des duo_wait)
- `no_state` — **4** (3.6% des duo_wait)
...
- `shock_inversion_stop` — 95 trades
- `fluid_exit_inversion` — 18 trades
- `fluid_exit_brake` — 4 trades
- `shock_exit_10bps` — 3 trades

- Sorties `shock_inversion_stop` : **98**
- Sorties `stop_loss` : **0**
...
Observé : **35** fois (31.8% des duo_wait).

### 3. radar_block en amont (786 SKIP)

Même si le duo était parfait, 72.4% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
