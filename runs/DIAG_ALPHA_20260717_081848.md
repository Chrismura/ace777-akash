...
> Généré: `2026-07-17T08:18:48Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 5 | 36 |
| PnL net | 0.0000 USDT | 0.9942 USDT |
| SKIP total | 287 | 239 |
| duo_wait | 17 (5.9% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **17** (100.0% des duo_wait)
...
### 3. radar_block en amont (208 SKIP)

Même si le duo était parfait, 72.5% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
