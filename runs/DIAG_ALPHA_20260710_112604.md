...
> Généré: `2026-07-10T11:26:04Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 2 |
| PnL net | 0.5312 USDT | -0.0019 USDT |
| SKIP total | 42 | 43 |
| duo_wait | 3 (7.1% des SKIP ALPHA) | 0 |
...
Même si le duo était parfait, 35.7% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
