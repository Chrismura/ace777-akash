...
> Généré: `2026-07-10T13:42:33Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 3 | 14 |
| PnL net | -4.3160 USDT | -0.2022 USDT |
| SKIP total | 77 | 59 |
| duo_wait | 13 (16.9% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **11** (84.6% des duo_wait)
- `no_state` — **2** (15.4% des duo_wait)
...
Même si le duo était parfait, 44.2% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
