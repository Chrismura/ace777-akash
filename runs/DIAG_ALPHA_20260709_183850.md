...
> Généré: `2026-07-09T18:38:50Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 5 | 11 |
| PnL net | -0.3154 USDT | 0.1591 USDT |
| SKIP total | 90 | 58 |
| duo_wait | 6 (6.7% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **4** (66.7% des duo_wait)
- `no_state` — **2** (33.3% des duo_wait)
...
### 3. radar_block en amont (71 SKIP)

Même si le duo était parfait, 78.9% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
