...
> Généré: `2026-07-12T16:10:44Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
| SKIP total | 104 | 104 |
| duo_wait | 9 (8.7% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **7** (77.8% des duo_wait)
- `no_state` — **2** (22.2% des duo_wait)
...
### 3. radar_block en amont (86 SKIP)

Même si le duo était parfait, 82.7% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
