# DIAGNOSTIC ALPHA — NUAGE_PROD_720H

> Généré: `2026-07-16T09:44:56Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 1 | 22 |
| PnL net | -0.8877 USDT | 0.6502 USDT |
| SKIP total | 120 | 82 |
| duo_wait | 6 (5.0% des SKIP ALPHA) | 0 |
...
- `shock_inversion_stop` — 19 trades
- `fluid_exit_inversion` — 2 trades
- `fluid_exit_brake` — 1 trades

- Sorties `shock_inversion_stop` : **19**
- Sorties `stop_loss` : **0**
