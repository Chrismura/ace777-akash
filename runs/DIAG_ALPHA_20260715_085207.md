...
> Généré: `2026-07-15T08:52:07Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 3 | 80 |
| PnL net | 7.3746 USDT | 0.5232 USDT |
| SKIP total | 521 | 361 |
| duo_wait | 39 (7.5% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **38** (97.4% des duo_wait)
- `no_state` — **1** (2.6% des duo_wait)
...
- `shock_inversion_stop` — 57 trades
- `fluid_exit_inversion` — 16 trades
- `fluid_exit_brake` — 7 trades

- Sorties `shock_inversion_stop` : **57**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (363 SKIP)

Même si le duo était parfait, 69.7% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
