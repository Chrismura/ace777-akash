...
> Généré: `2026-07-19T12:36:04Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 5 | 146 |
| PnL net | 3.1706 USDT | 2.8032 USDT |
| SKIP total | 1529 | 1284 |
| duo_wait | 118 (7.7% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **117** (99.2% des duo_wait)
...
- `shock_inversion_stop` — 127 trades
- `fluid_exit_inversion` — 10 trades
- `fluid_exit_brake` — 9 trades

- Sorties `shock_inversion_stop` : **127**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (1148 SKIP)

Même si le duo était parfait, 75.1% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
