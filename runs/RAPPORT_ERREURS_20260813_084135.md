...
`WHY_ARRET=unknown | ran_min=9.9 | vs_planned_min=+452.8 | timing=early_stop`

- Généré : `2026-08-13T08:41:35Z`
- Fenêtre depuis : `2026-08-13T07:18:30Z`
- Fin process : `2026-08-13T07:28:24Z`
- Meta start/end : `2026-08-13T07:18:30Z` → `2026-08-13T15:01:13Z`
...
- Issues duo (774) — scout/hunter désynchro.
...
| E-DUO | 774 | no_trigger / stale duo |
| E-SPREAD | 1080 | spread trop large |
| I-HUNTER | 0 | STORM_HUNTER arm (info) |

## PnL fills (fenêtre)

- ALPHA : fills=2 pnl=+1.6361 exits={'fluid_exit_brake': 1, 'shock_inversion_stop': 1}
- BETA : fills=34 pnl=-0.0528 exits={'shock_inversion_stop': 29, 'fluid_exit_inversion': 4, 'fluid_exit_brake': 1}
- **TOTAL** : +1.5833

## Derniers PROCESS_DIE / EXIT

- `[ALPHA_X13_BURST13] 2026-08-13T07:28:24Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_1 rc=1`
