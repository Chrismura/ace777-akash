...
> Généré: `2026-07-10T18:15:11Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 5 | 29 |
| PnL net | 3.5629 USDT | 0.7329 USDT |
| SKIP total | 78 | 82 |
| duo_wait | 10 (12.8% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **10** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 28 trades
- `fluid_exit_brake` — 1 trades

- Sorties `shock_inversion_stop` : **28**
- Sorties `stop_loss` : **0**
