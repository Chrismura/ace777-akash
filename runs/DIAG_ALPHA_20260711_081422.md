...
> Généré: `2026-07-11T08:14:22Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 8 | 10 |
| PnL net | 0.1868 USDT | -0.2815 USDT |
| SKIP total | 63 | 62 |
| duo_wait | 5 (7.9% des SKIP ALPHA) | 0 |
...
### 3. radar_block en amont (43 SKIP)

Même si le duo était parfait, 68.3% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
