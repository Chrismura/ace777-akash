...
> Généré: `2026-07-20T17:25:59Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 1 | 9 |
| PnL net | -2.0494 USDT | 0.5754 USDT |
| SKIP total | 158 | 29 |
| duo_wait | 37 (23.4% des SKIP ALPHA) | 0 |
...
- `stale_state` — **31** (83.8% des duo_wait)
- `no_trigger` — **6** (16.2% des duo_wait)
...
Observé : **31** fois (83.8% des duo_wait).

### 3. radar_block en amont (92 SKIP)

Même si le duo était parfait, 58.2% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
