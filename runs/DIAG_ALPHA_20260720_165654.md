...
> Généré: `2026-07-20T16:56:54Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 9 | 133 |
| PnL net | 4.2744 USDT | 1.2110 USDT |
| SKIP total | 696 | 443 |
| duo_wait | 91 (13.1% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **90** (98.9% des duo_wait)
- `no_state` — **1** (1.1% des duo_wait)
...
### 3. radar_block en amont (500 SKIP)

Même si le duo était parfait, 71.8% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
