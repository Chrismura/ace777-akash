...
> Généré: `2026-07-13T13:30:57Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 1 | 3 |
| PnL net | -16.8392 USDT | 0.5233 USDT |
| SKIP total | 25 | 38 |
| duo_wait | 1 (4.0% des SKIP ALPHA) | 0 |
...
Même si le duo était parfait, 16.0% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
