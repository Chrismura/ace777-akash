...
> Généré: `2026-07-21T14:50:09Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 105 |
| PnL net | -1.9521 USDT | -0.2726 USDT |
| SKIP total | 1595 | 1190 |
| duo_wait | 103 (6.5% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **103** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 64 trades
...
### 3. radar_block en amont (1026 SKIP)

Même si le duo était parfait, 64.3% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
