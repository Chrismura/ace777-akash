...
> Généré: `2026-07-19T08:26:03Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 1 | 24 |
| PnL net | -0.0260 USDT | 1.0033 USDT |
| SKIP total | 410 | 397 |
| duo_wait | 17 (4.1% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **15** (88.2% des duo_wait)
- `no_state` — **1** (5.9% des duo_wait)
- `stale_state` — **1** (5.9% des duo_wait)
...
Observé : **1** fois (5.9% des duo_wait).

### 3. radar_block en amont (328 SKIP)

Même si le duo était parfait, 80.0% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
