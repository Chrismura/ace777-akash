...
> Généré: `2026-07-12T10:35:29Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 8 |
| PnL net | -0.2076 USDT | -0.2051 USDT |
| SKIP total | 120 | 110 |
| duo_wait | 10 (8.3% des SKIP ALPHA) | 0 |
...
### 3. radar_block en amont (97 SKIP)

Même si le duo était parfait, 80.8% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
