...
> Généré: `2026-07-12T16:59:57Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 1 |
| PnL net | 0.0000 USDT | -0.0084 USDT |
| SKIP total | 9 | 7 |
| duo_wait | 3 (33.3% des SKIP ALPHA) | 0 |
...
Même si le duo était parfait, 44.4% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
