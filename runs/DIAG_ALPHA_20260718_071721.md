...
> Généré: `2026-07-18T07:17:21Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 59 |
| PnL net | 0.0000 USDT | 0.8984 USDT |
| SKIP total | 742 | 656 |
| duo_wait | 56 (7.5% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **56** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 51 trades
- `fluid_exit_brake` — 5 trades
- `fluid_exit_inversion` — 3 trades

- Sorties `shock_inversion_stop` : **51**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (514 SKIP)
