...
> Généré: `2026-07-10T15:51:35Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 5 | 5 |
| PnL net | -4.0885 USDT | 0.2935 USDT |
| SKIP total | 57 | 74 |
...
### 3. radar_block en amont (39 SKIP)

Même si le duo était parfait, 68.4% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
