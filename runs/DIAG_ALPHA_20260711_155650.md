...
> Généré: `2026-07-11T15:56:50Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 15 |
| PnL net | 0.0000 USDT | 1.2371 USDT |
| SKIP total | 108 | 78 |
| duo_wait | 23 (21.3% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **21** (91.3% des duo_wait)
- `no_state` — **2** (8.7% des duo_wait)
...
### 3. radar_block en amont (75 SKIP)

Même si le duo était parfait, 69.4% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
