...
> Généré: `2026-07-08T16:23:33Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 24 | 20 |
| PnL net | 0.5082 USDT | -0.6751 USDT |
| SKIP total | 945 | 980 |
| duo_wait | 59 (6.2% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **59** (100.0% des duo_wait)
...
### 3. radar_block en amont (712 SKIP)

Même si le duo était parfait, 75.3% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
