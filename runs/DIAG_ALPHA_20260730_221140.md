...
> Généré: `2026-07-30T22:11:40Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 48 |
| PnL net | -2.7554 USDT | 1.4740 USDT |
| SKIP total | 297 | 193 |
| duo_wait | 36 (12.1% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **35** (97.2% des duo_wait)
- `no_state` — **1** (2.8% des duo_wait)
...
### 3. radar_block en amont (192 SKIP)

Même si le duo était parfait, 64.6% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
