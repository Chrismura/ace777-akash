...
> Généré: `2026-07-18T05:08:42Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 4 | 153 |
| PnL net | 13.1932 USDT | 0.4087 USDT |
| SKIP total | 1456 | 1167 |
| duo_wait | 131 (9.0% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **130** (99.2% des duo_wait)
- `no_state` — **1** (0.8% des duo_wait)
...
- `shock_inversion_stop` — 124 trades
- `fluid_exit_inversion` — 15 trades
- `fluid_exit_brake` — 13 trades
- `shock_exit_10bps` — 1 trades

- Sorties `shock_inversion_stop` : **125**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (1108 SKIP)

Même si le duo était parfait, 76.1% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
