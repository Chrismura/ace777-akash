...
`WHY_ARRET=unknown | ran_min=247.6 | vs_planned_min=+5512.4 | timing=early_stop`

- Généré : `2026-08-16T14:54:38Z`
- Fenêtre depuis : `2026-08-16T10:46:52Z`
- Fin process : `2026-08-16T14:54:30Z`
- Meta start/end : `2026-08-16T10:46:52Z` → `2026-08-20T10:46:52Z`
...
- Issues duo (1116) — scout/hunter désynchro.
...
| E-DUO | 1116 | no_trigger / stale duo |
| E-SPREAD | 1296 | spread trop large |
| I-HUNTER | 0 | STORM_HUNTER arm (info) |

## PnL fills (fenêtre)

- ALPHA : fills=0 pnl=+0.0000 exits={}
- BETA : fills=20 pnl=+0.0739 exits={'shock_inversion_stop': 12, 'fluid_exit_brake': 5, 'fluid_exit_inversion': 2, 'kill_switch': 1}
- **TOTAL** : +0.0739

## Derniers PROCESS_DIE / EXIT

- `[ALPHA_X13_BURST13] 2026-08-16T14:54:13Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_0 rc=0`
- `[BETA_X5] 2026-08-16T14:54:30Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_0 rc=0`
- `2026-08-16T14:54:13Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_0 rc=0`
- `2026-08-16T14:54:30Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_0 rc=0`
