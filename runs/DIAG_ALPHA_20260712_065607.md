...
> Généré: `2026-07-12T06:56:07Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 1 |
| PnL net | 0.0000 USDT | 0.0800 USDT |
| SKIP total | 27 | 26 |
| duo_wait | 1 (3.7% des SKIP ALPHA) | 0 |
...
### 3. radar_block en amont (16 SKIP)

Même si le duo était parfait, 59.3% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
