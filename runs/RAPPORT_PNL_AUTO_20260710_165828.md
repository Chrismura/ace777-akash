...
**Période:** 2026-07-10T16:54:57Z → 2026-07-10T16:58:21Z (0h03m)
...
**Généré:** 2026-07-10T16:58:28Z UTC
**Filtre session:** `ts >= 2026-07-10T16:54:41Z` (lignes CSV antérieures exclues)
...
| Métrique | Valeur |
|----------|--------|
| **PNL BETA** | **+0.0365 USDT** |
| **PNL ALPHA** | **+0.0000 USDT** |
| **PNL SESSION TOTAL** | **+0.0365 USDT** |
| Statut | `POSITIF` |
...
| Flat (0) | 1 |
| Win rate | **33.3%** |
| Gains totaux | +0.0393 USDT |
| Pertes totales | -0.0028 USDT |
| **PNL net** | **+0.0365 USDT** |
| BPS moyen | 0.10 |

**Meilleur trade:** +0.0393 USDT
**Pire trade:** -0.0028 USDT
