...
> Généré: `2026-07-12T12:32:02Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 8 |
| PnL net | 2.2601 USDT | 0.1509 USDT |
| SKIP total | 27 | 23 |
| duo_wait | 2 (7.4% des SKIP ALPHA) | 0 |
...
Même si le duo était parfait, 81.5% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
