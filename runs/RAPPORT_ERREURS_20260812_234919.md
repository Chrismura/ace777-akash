...
`WHY_ARRET=unknown | ran_min=21.7 | vs_planned_min=+458.4 | timing=early_stop`

- Généré : `2026-08-12T23:49:19Z`
- Fenêtre depuis : `2026-08-12T23:27:36Z`
- Fin process : `2026-08-12T23:49:16Z`
- Meta start/end : `2026-08-12T23:27:36Z` → `2026-08-13T07:27:37Z`
...
- Issues duo (987) — scout/hunter désynchro.
...
| E-DUO | 987 | no_trigger / stale duo |
| E-SPREAD | 1282 | spread trop large |
| I-HUNTER | 0 | STORM_HUNTER arm (info) |

## PnL fills (fenêtre)

- ALPHA : fills=5 pnl=+0.3771 exits={'shock_inversion_stop': 4, 'fluid_exit_brake': 1}
- BETA : fills=7 pnl=-0.1175 exits={'shock_inversion_stop': 4, 'fluid_exit_inversion': 2, 'fluid_exit_brake': 1}
- **TOTAL** : +0.2596

## Derniers PROCESS_DIE / EXIT

- `[BETA_X5] 2026-08-12T23:43:57Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_1 rc=1`
- `[ALPHA_X13_BURST13] 2026-08-12T23:49:16Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_1 rc=1`
- `2026-08-12T23:43:57Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_1 rc=1`
- `2026-08-12T23:49:16Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_1 rc=1`
