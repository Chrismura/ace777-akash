...
> Généré: `2026-07-31T13:59:36Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 37 |
| PnL net | 8.0032 USDT | 0.6630 USDT |
| SKIP total | 914 | 886 |
| duo_wait | 21 (2.3% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **21** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 18 trades
- `fluid_exit_inversion` — 16 trades
- `fluid_exit_brake` — 3 trades

- Sorties `shock_inversion_stop` : **18**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (826 SKIP)

Même si le duo était parfait, 90.4% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
