...
> Généré: `2026-07-12T06:51:40Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 7 |
| PnL net | 0.0000 USDT | 0.2048 USDT |
| SKIP total | 37 | 22 |
| duo_wait | 8 (21.6% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **8** (100.0% des duo_wait)
...
### 3. radar_block en amont (20 SKIP)

Même si le duo était parfait, 54.1% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
