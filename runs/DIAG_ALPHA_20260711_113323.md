...
> Généré: `2026-07-11T11:33:23Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 9 | 40 |
| PnL net | 0.5468 USDT | 0.3361 USDT |
| SKIP total | 337 | 306 |
| duo_wait | 30 (8.9% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **29** (96.7% des duo_wait)
- `no_state` — **1** (3.3% des duo_wait)
...
- `shock_inversion_stop` — 30 trades
- `fluid_exit_inversion` — 5 trades
- `fluid_exit_brake` — 5 trades

- Sorties `shock_inversion_stop` : **30**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (217 SKIP)

Même si le duo était parfait, 64.4% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
