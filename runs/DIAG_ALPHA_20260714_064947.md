...
> Généré: `2026-07-14T06:49:47Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 16 | 91 |
| PnL net | -11.9994 USDT | 1.0533 USDT |
| SKIP total | 340 | 796 |
| duo_wait | 24 (7.1% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **20** (83.3% des duo_wait)
- `stale_state` — **4** (16.7% des duo_wait)
...
- `shock_inversion_stop` — 74 trades
- `fluid_exit_inversion` — 10 trades
- `fluid_exit_brake` — 7 trades

- Sorties `shock_inversion_stop` : **74**
- Sorties `stop_loss` : **0**
...
Observé : **4** fois (16.7% des duo_wait).

### 3. radar_block en amont (279 SKIP)

Même si le duo était parfait, 82.1% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
