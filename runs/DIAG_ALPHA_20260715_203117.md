...
> Généré: `2026-07-15T20:31:17Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 11 | 208 |
| PnL net | 46.4580 USDT | -6.2442 USDT |
| SKIP total | 1520 | 1134 |
| duo_wait | 148 (9.7% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **148** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 163 trades
- `fluid_exit_inversion` — 21 trades
...
### 3. radar_block en amont (1009 SKIP)

Même si le duo était parfait, 66.4% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
