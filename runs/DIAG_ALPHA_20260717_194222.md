...
> Généré: `2026-07-17T19:42:22Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 1 | 42 |
| PnL net | -0.0243 USDT | 0.4890 USDT |
| SKIP total | 385 | 239 |
| duo_wait | 55 (14.3% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **37** (67.3% des duo_wait)
- `stale_state` — **17** (30.9% des duo_wait)
- `no_state` — **1** (1.8% des duo_wait)
...
- `shock_inversion_stop` — 34 trades
- `fluid_exit_brake` — 5 trades
- `fluid_exit_inversion` — 3 trades

- Sorties `shock_inversion_stop` : **34**
- Sorties `stop_loss` : **0**
...
Observé : **17** fois (30.9% des duo_wait).

### 3. radar_block en amont (265 SKIP)

Même si le duo était parfait, 68.8% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
