...
> Généré: `2026-07-10T14:16:55Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 3 |
| PnL net | 0.0000 USDT | 0.7176 USDT |
| SKIP total | 29 | 65 |
| duo_wait | 5 (17.2% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **3** (60.0% des duo_wait)
- `no_state` — **1** (20.0% des duo_wait)
- `stale_state` — **1** (20.0% des duo_wait)
...
Observé : **1** fois (20.0% des duo_wait).

### 3. radar_block en amont (18 SKIP)

Même si le duo était parfait, 62.1% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
