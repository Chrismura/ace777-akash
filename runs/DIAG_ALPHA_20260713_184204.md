...
> Généré: `2026-07-13T18:42:04Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 10 | 93 |
| PnL net | 0.0025 USDT | 1.5123 USDT |
| SKIP total | 204 | 427 |
| duo_wait | 25 (12.3% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **25** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 85 trades
- `fluid_exit_brake` — 4 trades
- `fluid_exit_inversion` — 4 trades

- Sorties `shock_inversion_stop` : **85**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (155 SKIP)

Même si le duo était parfait, 76.0% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
