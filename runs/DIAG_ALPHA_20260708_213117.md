...
> Généré: `2026-07-08T21:31:17Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 2 |
| PnL net | 0.0000 USDT | -0.0318 USDT |
| SKIP total | 185 | 184 |
| duo_wait | 9 (4.9% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **9** (100.0% des duo_wait)
...
### 3. radar_block en amont (164 SKIP)

Même si le duo était parfait, 88.6% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
