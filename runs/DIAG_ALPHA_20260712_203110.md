...
> Généré: `2026-07-12T20:31:10Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 2 | 18 |
| PnL net | 0.5710 USDT | -0.0183 USDT |
| SKIP total | 125 | 117 |
| duo_wait | 14 (11.2% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **12** (85.7% des duo_wait)
- `no_state` — **1** (7.1% des duo_wait)
- `stale_state` — **1** (7.1% des duo_wait)
...
Observé : **1** fois (7.1% des duo_wait).
