...
> Généré: `2026-07-10T14:21:47Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 2 |
| PnL net | 0.0000 USDT | 0.0732 USDT |
| SKIP total | 12 | 35 |
| duo_wait | 6 (50.0% des SKIP ALPHA) | 0 |
...
- `stale_state` — **2** (33.3% des duo_wait)
...
Observé : **2** fois (33.3% des duo_wait).

### 3. radar_block en amont (5 SKIP)

Même si le duo était parfait, 41.7% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
