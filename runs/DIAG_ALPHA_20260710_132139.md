...
> Généré: `2026-07-10T13:21:39Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 5 | 15 |
| PnL net | 0.2781 USDT | 0.5047 USDT |
| SKIP total | 63 | 66 |
| duo_wait | 9 (14.3% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **8** (88.9% des duo_wait)
- `no_state` — **1** (11.1% des duo_wait)
...
Même si le duo était parfait, 71.4% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
