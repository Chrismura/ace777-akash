...
> Généré: `2026-07-16T06:34:01Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 3 | 91 |
| PnL net | 1.0848 USDT | -0.6326 USDT |
| SKIP total | 718 | 556 |
| duo_wait | 82 (11.4% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **81** (98.8% des duo_wait)
- `no_state` — **1** (1.2% des duo_wait)
...
- `fluid_exit_inversion` — 17 trades
- `fluid_exit_brake` — 11 trades

- Sorties `shock_inversion_stop` : **63**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (496 SKIP)

Même si le duo était parfait, 69.1% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
