...
> Généré: `2026-07-15T16:30:08Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 3 | 86 |
| PnL net | 3.1624 USDT | 1.3061 USDT |
| SKIP total | 620 | 459 |
| duo_wait | 58 (9.4% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **58** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 60 trades
- `fluid_exit_inversion` — 19 trades
- `fluid_exit_brake` — 7 trades

- Sorties `shock_inversion_stop` : **60**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (437 SKIP)

Même si le duo était parfait, 70.5% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
