...
> Généré: `2026-07-15T12:38:40Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 1 | 16 |
| PnL net | -0.4433 USDT | -1.5777 USDT |
| SKIP total | 165 | 142 |
| duo_wait | 10 (6.1% des SKIP ALPHA) | 0 |
...
- `no_state` — **5** (50.0% des duo_wait)
- `no_trigger` — **5** (50.0% des duo_wait)
...
### 3. radar_block en amont (133 SKIP)
