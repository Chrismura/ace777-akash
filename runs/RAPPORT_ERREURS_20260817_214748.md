...
- Généré : `2026-08-17T21:47:48Z`
- Fenêtre depuis : `2026-08-17T21:28:06Z`
- Fin process : ``
- Meta start/end : `2026-08-17T21:28:06Z` → `2026-08-18T01:27:23Z`
...
- **WHY_ARRET=no_process_exit_logged**
- Issues duo (57) — scout/hunter désynchro.
...
| E-DUO | 57 | no_trigger / stale duo |
| E-SPREAD | 22 | spread trop large |
| I-HUNTER | 0 | STORM_HUNTER arm (info) |

## PnL fills (fenêtre)

- ALPHA : fills=6 pnl=+0.3891 exits={'shock_inversion_stop': 4, 'fluid_exit_brake': 1, 'fluid_exit_inversion': 1}
- BETA : fills=10 pnl=+0.1222 exits={'fluid_exit_inversion': 5, 'shock_inversion_stop': 4, 'fluid_exit_brake': 1}
- **TOTAL** : +0.5113
