...
> Généré: `2026-08-16T14:54:34Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 20 |
| PnL net | 0.0000 USDT | 0.0739 USDT |
| SKIP total | 884 | 1036 |
| duo_wait | 59 (6.7% des SKIP ALPHA) | 0 |
...
### 3. radar_block en amont (663 SKIP)

Même si le duo était parfait, 75.0% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
