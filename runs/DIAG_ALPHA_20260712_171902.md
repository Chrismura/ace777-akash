...
> Généré: `2026-07-12T17:19:02Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 4 | 14 |
| PnL net | 0.6908 USDT | -0.0758 USDT |
| SKIP total | 59 | 61 |
| duo_wait | 7 (11.9% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **6** (85.7% des duo_wait)
...
- Sorties `shock_inversion_stop` : **11**
- Sorties `stop_loss` : **0**
...
Même si le duo était parfait, 74.6% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
