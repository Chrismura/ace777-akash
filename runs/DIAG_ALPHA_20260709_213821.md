...
> Généré: `2026-07-09T21:38:21Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 3 |
| PnL net | 0.0000 USDT | 0.0603 USDT |
| SKIP total | 114 | 99 |
| duo_wait | 3 (2.6% des SKIP ALPHA) | 0 |
...
- `no_state` — **2** (66.7% des duo_wait)
- `no_trigger` — **1** (33.3% des duo_wait)
...
### 3. radar_block en amont (11 SKIP)
