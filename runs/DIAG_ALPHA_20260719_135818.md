...
> Généré: `2026-07-19T13:58:18Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 5 | 20 |
| PnL net | 1.5079 USDT | 0.7054 USDT |
| SKIP total | 168 | 142 |
| duo_wait | 13 (7.7% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **10** (76.9% des duo_wait)
...
- Sorties `shock_inversion_stop` : **15**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (125 SKIP)

Même si le duo était parfait, 74.4% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
