# DIAGNOSTIC ALPHA — NUAGE_SMOKE_1807Z

> Généré: `2026-07-14T18:29:22Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 1 | 10 |
| PnL net | -1.1853 USDT | -0.1156 USDT |
| SKIP total | 98 | 67 |
| duo_wait | 7 (7.1% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **5** (71.4% des duo_wait)
- `no_state` — **1** (14.3% des duo_wait)
- `stale_state` — **1** (14.3% des duo_wait)
...
Observé : **1** fois (14.3% des duo_wait).

### 3. radar_block en amont (69 SKIP)

Même si le duo était parfait, 70.4% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
