...
> Généré: `2026-07-31T18:19:30Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 6 | 161 |
| PnL net | 2.8561 USDT | -5.9965 USDT |
| SKIP total | 1323 | 999 |
| duo_wait | 112 (8.5% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **112** (100.0% des duo_wait)
...
- `shock_inversion_stop` — 91 trades
- `fluid_exit_inversion` — 48 trades
- `fluid_exit_brake` — 18 trades
- `shock_exit_10bps` — 4 trades

- Sorties `shock_inversion_stop` : **95**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (917 SKIP)

Même si le duo était parfait, 69.3% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
