...
> Généré: `2026-07-10T19:39:40Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 8 | 9 |
| PnL net | 13.9080 USDT | -0.6791 USDT |
| SKIP total | 59 | 35 |
...
- `stale_state` — **2** (66.7% des duo_wait)
...
Observé : **2** fois (66.7% des duo_wait).

### 3. radar_block en amont (52 SKIP)

Même si le duo était parfait, 88.1% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
