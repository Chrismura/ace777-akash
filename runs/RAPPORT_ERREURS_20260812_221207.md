...
`WHY_ARRET=unknown | ran_min=1.5 | vs_planned_min=+58.5 | timing=early_stop`

- Généré : `2026-08-12T22:12:07Z`
- Fenêtre depuis : `2026-08-12T22:10:34Z`
- Fin process : `2026-08-12T22:12:05Z`
- Meta start/end : `2026-08-12T22:10:34Z` → `2026-08-12T23:10:34Z`
...
- Issues duo (1021) — scout/hunter désynchro.
...
| E-DUO | 1021 | no_trigger / stale duo |
| E-SPREAD | 1339 | spread trop large |
| I-HUNTER | 0 | STORM_HUNTER arm (info) |

## PnL fills (fenêtre)

- ALPHA : fills=1 pnl=+0.0000 exits={'kill_switch': 1}
- BETA : fills=1 pnl=-0.1981 exits={'shock_inversion_stop': 1}
- **TOTAL** : -0.1981

## Derniers PROCESS_DIE / EXIT

- `[BETA_X5] 2026-08-12T22:12:00Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_0 rc=0`
- `[ALPHA_X13_BURST13] 2026-08-12T22:12:05Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_0 rc=0`
- `2026-08-12T22:12:00Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_0 rc=0`
- `2026-08-12T22:12:05Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_0 rc=0`
