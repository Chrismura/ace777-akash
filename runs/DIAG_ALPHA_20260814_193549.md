...
> Généré: `2026-08-14T19:35:49Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 26 | 131 |
| PnL net | 9.0607 USDT | 1.6846 USDT |
| SKIP total | 1345 | 1094 |
| duo_wait | 103 (7.7% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **101** (98.1% des duo_wait)
- `no_state` — **2** (1.9% des duo_wait)
...
- `shock_inversion_stop` — 117 trades
- `fluid_exit_inversion` — 11 trades
- `fluid_exit_brake` — 2 trades
- `kill_switch` — 1 trades

- Sorties `shock_inversion_stop` : **117**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (1023 SKIP)
