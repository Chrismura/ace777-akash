...
> Généré: `2026-07-20T04:49:21Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 3 | 179 |
| PnL net | 8.9146 USDT | -0.4235 USDT |
| SKIP total | 1553 | 1220 |
| duo_wait | 145 (9.3% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **145** (100.0% des duo_wait)
...
- Sorties `shock_inversion_stop` : **154**
- Sorties `stop_loss` : **0**
...
### 3. radar_block en amont (1152 SKIP)
