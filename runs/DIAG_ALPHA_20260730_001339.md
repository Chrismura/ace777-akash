# DIAGNOSTIC ALPHA — VALIDATION_VOIE_A_PACK_B

> Généré: `2026-07-30T00:13:39Z` | Verdict: **OK — ALPHA active**
...
|----------|-------|------------------|
| FILLED | 13 | 110 |
| PnL net | -19.1938 USDT | 0.0122 USDT |
| SKIP total | 531 | 1411 |
| duo_wait | 27 (5.1% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **27** (100.0% des duo_wait)
...
### 3. radar_block en amont (421 SKIP)

Même si le duo était parfait, 79.3% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
