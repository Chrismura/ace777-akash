...
> Généré: `2026-07-10T15:00:41Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 9 | 15 |
| PnL net | -0.8625 USDT | -1.1490 USDT |
| SKIP total | 120 | 116 |
| duo_wait | 11 (9.2% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **8** (72.7% des duo_wait)
- `stale_state` — **2** (18.2% des duo_wait)
- `no_state` — **1** (9.1% des duo_wait)
...
Observé : **2** fois (18.2% des duo_wait).

### 3. radar_block en amont (93 SKIP)

Même si le duo était parfait, 77.5% des cycles ALPHA meurent au radar avant d'atteindre le HUNTER.
