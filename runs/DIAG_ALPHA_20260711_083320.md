...
> Généré: `2026-07-11T08:33:20Z` | Verdict: **ALERTE — ALPHA quasi dormante**
...
|----------|-------|------------------|
| FILLED | 5 | 16 |
| PnL net | 0.6375 USDT | 0.0413 USDT |
| SKIP total | 63 | 87 |
| duo_wait | 10 (15.9% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **8** (80.0% des duo_wait)
- `no_state` — **2** (20.0% des duo_wait)
...
### 3. radar_block en amont (48 SKIP)
