...
> Généré: `2026-07-11T19:07:27Z` | Verdict: **CRITIQUE — ALPHA n'a exécuté aucun trade**
...
|----------|-------|------------------|
| FILLED | 0 | 22 |
| PnL net | 0.0000 USDT | 0.4672 USDT |
| SKIP total | 167 | 121 |
| duo_wait | 22 (13.2% des SKIP ALPHA) | 0 |
...
- `no_trigger` — **21** (95.5% des duo_wait)
- `no_state` — **1** (4.5% des duo_wait)
...
### 3. radar_block en amont (122 SKIP)
