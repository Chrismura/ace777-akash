...
`WHY_ARRET=unknown | ran_min=108.3 | vs_planned_min=+5366.0 | timing=early_stop`

- Généré : `2026-08-16T17:21:11Z`
- Fenêtre depuis : `2026-08-16T15:32:30Z`
- Fin process : `2026-08-16T17:20:50Z`
- Meta start/end : `2026-08-16T15:32:30Z` → `2026-08-20T10:46:52Z`
...
- Issues duo (580) — scout/hunter désynchro.
...
| E-DUO | 580 | no_trigger / stale duo |
| E-SPREAD | 843 | spread trop large |
| I-HUNTER | 0 | STORM_HUNTER arm (info) |

## PnL fills (fenêtre)

- ALPHA : fills=0 pnl=+0.0000 exits={}
- BETA : fills=11 pnl=-1.3799 exits={'shock_inversion_stop': 6, 'fluid_exit_inversion': 3, 'fluid_exit_brake': 1, 'kill_switch': 1}
- **TOTAL** : -1.3799

## Derniers PROCESS_DIE / EXIT

- `[ALPHA_X13_BURST13] 2026-08-16T17:19:03Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_0 rc=0`
- `[BETA_X5] 2026-08-16T17:20:50Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_0 rc=0`
- `2026-08-16T17:19:03Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_0 rc=0`
- `2026-08-16T17:20:50Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_0 rc=0`
