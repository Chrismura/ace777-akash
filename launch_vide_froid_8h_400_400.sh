#!/bin/bash
# === VIDE FROID 8H - Protocole ACE777 (400/400) ===
# Identique a launch_vide_froid_8h.sh, avec seulement:
# - BUY_USDT_BETA=400
# - BUY_USDT_ALPHA=400
