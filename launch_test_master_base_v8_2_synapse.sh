...
export TEST_TAG_OVERRIDE="MASTER_BASE_V8_2_SYNAPSE_7H30"
...
# Mode signal: pas de double filtre radar
...
echo "=== V8.2 SYNAPSE === objectif: stabilite 77 USDT/jour (cible), non garantie."
