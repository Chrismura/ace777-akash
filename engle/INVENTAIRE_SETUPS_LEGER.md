...
## Couches Engle évolutives (2026-07-19)

- Plan : `engle/PLAN_COUCHES_B1_B3.md`
- B1 journal : `scripts/engle_journal.rb` → `engle/journal/`
- B2 log-only : `scripts/engle_adapt.rb` · `ENGLE_ADAPT=0` (défaut usine) / `=log`
- Duo PID watchdog : `engle/DUO_PID_WATCHDOG.md` · `NUAGE_DUO_PID_WATCHDOG=1` (défaut) via `GO_USINE`
- B3 knobs : **pas encore** (interdit d’assouplir en COMPRESSÉ)
