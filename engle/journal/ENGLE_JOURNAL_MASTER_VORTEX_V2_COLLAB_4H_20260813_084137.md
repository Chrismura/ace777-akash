...
- Généré: `2026-08-13T08:41:37Z` (UTC)
...
|--------|--------|---|-------|-----------|
| COMPRESSÉ (attente à froid) | 575 | 88.1% | 0 | +0.0000 |
| TRANSITOIRE (bruit retail) | 43 | 6.6% | 0 | +0.0000 |
| CLUSTER (tension haute — proxy) | 35 | 5.4% | 34 | -0.0528 |

- Courant (proxy): **COMPRESSÉ (attente à froid)** · μ=0.1404 · σ=0.5159 · n=653
...
|-------|--------|-------|-------|------------------|---------|
| BETA | 653 | 34 | 619 | -0.0528 | `2026-08-13T07:18:40Z` → `2026-08-13T08:41:36Z` |
