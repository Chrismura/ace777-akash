...
`WHY_ARRET=unknown | ran_min=187.9 | vs_planned_min=+292.1 | timing=early_stop`

- Généré : `2026-08-13T15:45:03Z`
- Fenêtre depuis : `2026-08-13T12:37:04Z`
- Fin process : `2026-08-13T15:45:01Z`
- Meta start/end : `2026-08-13T12:37:04Z` → `2026-08-13T20:37:04Z`
...
- Issues duo (462) — scout/hunter désynchro.
...
| E-DUO | 462 | no_trigger / stale duo |
| E-SPREAD | 932 | spread trop large |
| I-HUNTER | 0 | STORM_HUNTER arm (info) |

## PnL fills (fenêtre)

- ALPHA : fills=0 pnl=+0.0000 exits={}
- BETA : fills=131 pnl=-0.0996 exits={'shock_inversion_stop': 102, 'fluid_exit_inversion': 25, 'fluid_exit_brake': 4}
- **TOTAL** : -0.0996

## Derniers PROCESS_DIE / EXIT

- `[ALPHA_X13_BURST13] 2026-08-13T12:46:07Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_1 rc=1`
- `[BETA_X5] 2026-08-13T15:45:01Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_0 rc=0`
- `2026-08-13T12:46:07Z PROCESS_EXIT unit=ALPHA_X13_BURST13 how=pipe_run_unit why=rc_1 rc=1`
- `2026-08-13T15:45:01Z PROCESS_EXIT unit=BETA_X5 how=pipe_run_unit why=rc_0 rc=0`
