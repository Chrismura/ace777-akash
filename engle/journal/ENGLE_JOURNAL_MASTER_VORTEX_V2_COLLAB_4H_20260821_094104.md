...
- Généré: `2026-08-21T09:41:04Z` (UTC)
...
|--------|--------|---|-------|-----------|
| COMPRESSÉ (attente à froid) | 246 | 88.5% | 18 | -1.1129 |
| TRANSITOIRE (bruit retail) | 30 | 10.8% | 0 | +0.0000 |
| CLUSTER (tension haute — proxy) | 2 | 0.7% | 0 | +0.0000 |

- Courant (proxy): **COMPRESSÉ (attente à froid)** · μ=0.0767 · σ=0.2408 · n=278
...
|-------|--------|-------|-------|------------------|---------|
| BETA | 278 | 18 | 260 | -1.1129 | `2026-08-21T09:25:13Z` → `2026-08-21T09:41:00Z` |
...
| Raison | Nb | % skips |
|--------|-----|---------|
| `gap_guard_pause` | 165 | 63.5% |
| `momentum_too_small` | 42 | 16.2% |
| `radar_block` | 24 | 9.2% |
| `wall_not_collapsed` | 24 | 9.2% |
