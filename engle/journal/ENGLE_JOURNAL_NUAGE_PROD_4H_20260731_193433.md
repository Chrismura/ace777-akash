...
- Généré: `2026-07-31T19:34:33Z` (UTC)
- Couche: **B1** (lecture seule) · `ENGLE_ADAPT=0`
- Session start (filtre): `2026-07-31T19:00:04Z`
...
|-------|--------|-------|-------|------------------|---------|
| BETA | 0 | 0 | 0 | +0.0000 | — |
| ALPHA | 46 | 0 | 46 | +0.0000 | `2026-07-31T19:00:17Z` → `2026-07-31T19:06:52Z` |
| **TOTAL** | | 0 | | **+0.0000** | |
...
| Raison | Nb | % skips |
|--------|-----|---------|
| `momentum_too_small` | 41 | 89.1% |
| `radar_block` | 4 | 8.7% |
| `wall_not_collapsed` | 1 | 2.2% |
