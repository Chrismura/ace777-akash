...
*Genere le 2026-08-30 par catalog_providers.py (gagnant A/B codeurs 09/08). Rafraichi a chaque veille du matin.*
...
| Role | Modele | Statut | Note |
|------|--------|--------|------|
| - | `nvidia/nemotron-3-nano-30b-a3b:free` | obs-1786774646 | TESTÉ 27/08 : 404 — modèle plus dispo en free (payant / endpoints supprimés). Reste désact |
| - | `nvidia/nemotron-nano-9b-v2:free` | obs-1787248844 | TESTÉ 27/08 : 404 — modèle plus dispo en free (payant / endpoints supprimés). Reste désact |
