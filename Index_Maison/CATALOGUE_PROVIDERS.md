...
*Genere le 2026-08-11 par catalog_providers.py (gagnant A/B codeurs 09/08). Rafraichi a chaque veille du matin.*

**Actifs : 8 · En observation : 0 · En attente : 5 · De cote (payant) : 0**
...
| analyse profonde / missions / analyse BTC / elaboration | `deepseek-ai/deepseek-v4-flash-0731` | nvidia | ACTIVE 08/08 - cle nvapi OK, DeepSeek V4 Flash |
| CODE | `codestral-latest` | mistral | ACTIVE 11/08 - cle Mistral OK (plan experiment 1 Md tokens/mois) - Codestral = modele code |
...
| Role | Modele | Statut | Note |
|------|--------|--------|------|
| demarrage / audit protocole / chat interactif / RAG coffre / analyse / brief vocal / synthese bookmarks | `gemini-flash-lite-latest` | gemini | - |
