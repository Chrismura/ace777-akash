...
> Testé le **2026-09-26T11:59Z** · mode **lecture seule** (rien installé, rien modifié).
> Question posée : *« si le Mac mourait ce soir, ACE777 reviendrait-il ? »*

## 1. Source — le repo (git) contient-il tout ?
- Branche `main` · HEAD `1c8571ed22` du 2026-09-26T13:55:46+02:00
- Fichiers suivis modifiés sur disque : **52**
- Fichiers suivis **supprimés** (perdus) : **0**
- Nouveaux fichiers non versionnés : 27926 au total, dont **43 sensibles** (scripts/plists/règles)
...
- Dossier : `/var/folders/y7/571v2gy574z72zvsgqd46wd40000gn/T/drill_restauration_wlvh9lv1/LaunchAgents`
...
- Chemins **hors repo** (à sauvegarder autrement, git ne les ramène PAS) : **9**
  ...
  **Organes du projet hors git** (git ne les ramène PAS → il faut une autre source) :
  ...
  Manifeste des organes hors repo : `thermo/organes_hors_repo.json` (mis à jour 2026-09-26T11:55Z).
