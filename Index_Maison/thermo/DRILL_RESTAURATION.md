...
> Testé le **2026-09-26T10:58Z** · mode **lecture seule** (rien installé, rien modifié).
> Question posée : *« si le Mac mourait ce soir, ACE777 reviendrait-il ? »*

## 1. Source — le repo (git) contient-il tout ?
- Branche `main` · HEAD `2d22db4dae` du 2026-09-26T12:55:09+02:00
- Fichiers suivis modifiés sur disque : **69**
- Fichiers suivis **supprimés** (perdus) : **0**
- Nouveaux fichiers non versionnés : 27924 au total, dont **43 sensibles** (scripts/plists/règles)
...
- Dossier : `/var/folders/y7/571v2gy574z72zvsgqd46wd40000gn/T/drill_restauration_m5f0vkx2/LaunchAgents`
...
- Chemins **hors repo** (à sauvegarder autrement, git ne les ramène PAS) : **9**
  ...
  **Organes du projet hors git** (git ne les ramène PAS → il faut une autre source) :
  ...
  Manifeste des organes hors repo : `thermo/organes_hors_repo.json` (mis à jour 2026-09-26T10:54Z).
