...
> Testé le **2026-09-23T14:08Z** · mode **lecture seule** (rien installé, rien modifié).
> Question posée : *« si le Mac mourait ce soir, ACE777 reviendrait-il ? »*

## 1. Source — le repo (git) contient-il tout ?
- Branche `main` · HEAD `ae5eb058bc` du 2026-09-23T15:19:22+02:00
- Fichiers suivis modifiés sur disque : **104**
- Fichiers suivis **supprimés** (perdus) : **0**
- Nouveaux fichiers non versionnés : 27050 au total, dont **43 sensibles** (scripts/plists/règles)
...
- Dossier : `/var/folders/y7/571v2gy574z72zvsgqd46wd40000gn/T/drill_restauration_hkt3q1vu/LaunchAgents`
...
- Chemins **hors repo** (à sauvegarder autrement, git ne les ramène PAS) : **9**
  ...
  **Organes du projet hors git** (git ne les ramène PAS → il faut une autre source) :
  ...
  Manifeste des organes hors repo : `thermo/organes_hors_repo.json` (mis à jour 2026-09-23T13:19Z).
...
## 6. Verdict
- 🔴 **2 trou(s) à combler :**
  - 1 instrument(s) que la boucle EXÉCUTE et qui ne sont PAS dans git → perdus à la restauration (hulk-mexc/scripts/ws_book.py)
