# 🎯 FICHE SET-UP INDIVIDUEL — WUSDT (W (Wormhole)) — 30/08/2026

> **Système unique, set-up propre à CET actif** (doctrine : même système, pas même set-up).
> Profil automatique : `hulk-mexc/runs/profils_actifs/PROFIL_WUSDT.md` (2288 points).
> Suivi quotidien : `hulk-mexc/runs/SUIVI_SETUP_WUSDT.md` (mesure jour par jour, plist 16:35 locale).
...
|---|---|---|
| **Range total** | 9.18% | Amplitude sur la fenêtre |
| **Creux intraday** | **22h UTC** | Fenêtre d'entrée : **21h / 22h / 23h** |
| **Pic intraday** | **1h UTC** | Fenêtre de sortie : **0h / 1h / 2h** |
| **Pattern jour/nuit** | distribué | Pattern faible (0.3%) — cycle horaire peu marqué, prudent |
| **Volatilité (dd15 moy)** | 11.75% | MODÉRÉ — dd15 moyen 12% |
| **Mur bid max** | 109290.0$ (spoof 1.37%) | Mur = INFO, spoof = TENSION |
| **Poussière moyenne** | 14.6% | Déclencheur entrée : < 15% |
| **Corrélation BTC** | 0.91 | fortement corrélé BTC (+0.91) → suit le marché |
...
3. **NON — actif de marché (filtre macro >1.5% BTC/ETH indispensable)** — fortement corrélé BTC (+0.91) → suit le marché.
...
## ⏱️ ÉTAT ACTUEL
- **WUSDT est suivie en observation** (doctrine : tous les actifs sous observation).
...
## Archives
- Profil : `hulk-mexc/runs/profils_actifs/PROFIL_WUSDT.md`
- Suivi : `hulk-mexc/runs/SUIVI_SETUP_WUSDT.jsonl` + `.md`
