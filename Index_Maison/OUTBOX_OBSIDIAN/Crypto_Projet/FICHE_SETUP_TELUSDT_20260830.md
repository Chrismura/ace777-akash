# 🎯 FICHE SET-UP INDIVIDUEL — TELUSDT (Telos) — 30/08/2026

> **Système unique, set-up propre à CET actif** (doctrine : même système, pas même set-up).
> Profil automatique : `hulk-mexc/runs/profils_actifs/PROFIL_TELUSDT.md` (2288 points).
> Suivi quotidien : `hulk-mexc/runs/SUIVI_SETUP_TELUSDT.md` (mesure jour par jour, plist 16:35 locale).
...
|---|---|---|
| **Range total** | 15.34% | Amplitude sur la fenêtre |
| **Creux intraday** | **22h UTC** | Fenêtre d'entrée : **21h / 22h / 23h** |
| **Pic intraday** | **1h UTC** | Fenêtre de sortie : **0h / 1h / 2h** |
| **Pattern jour/nuit** | distribué | Pattern faible (0.6%) — cycle horaire peu marqué, prudent |
| **Volatilité (dd15 moy)** | 13.14% | MODÉRÉ — dd15 moyen 13% |
| **Mur bid max** | 11632.0$ (spoof 1.57%) | Mur = INFO, spoof = TENSION |
| **Poussière moyenne** | 14.6% | Déclencheur entrée : < 15% |
| **Corrélation BTC** | 0.74 | moyennement corrélé BTC (+0.74) |
...
3. **PARTIEL — attention aux secousses macro** — moyennement corrélé BTC (+0.74).
...
## ⏱️ ÉTAT ACTUEL
- **TELUSDT est suivie en observation** (doctrine : tous les actifs sous observation).
...
## Archives
- Profil : `hulk-mexc/runs/profils_actifs/PROFIL_TELUSDT.md`
- Suivi : `hulk-mexc/runs/SUIVI_SETUP_TELUSDT.jsonl` + `.md`
