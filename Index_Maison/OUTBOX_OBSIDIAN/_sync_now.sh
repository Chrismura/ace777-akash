...
mkdir -p "$VAULT/$(dirname "Cahier/Journal_2026-08-13.md")" && cp "$OB/Cahier/Journal_2026-08-13.md" "$VAULT/Cahier/Journal_2026-08-13.md" && echo OK Cahier/Journal_2026-08-13.md
mkdir -p "$VAULT/$(dirname "Index_Maison/Journal_2026-08-13.md")" && cp "$OB/Index_Maison/Journal_2026-08-13.md" "$VAULT/Index_Maison/Journal_2026-08-13.md" && echo OK Index_Maison/Journal_2026-08-13.md
