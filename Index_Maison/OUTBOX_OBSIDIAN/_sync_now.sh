...
mkdir -p "$VAULT/$(dirname "Cahier/Journal_2026-08-16.md")" && cp "$OB/Cahier/Journal_2026-08-16.md" "$VAULT/Cahier/Journal_2026-08-16.md" && echo OK Cahier/Journal_2026-08-16.md
mkdir -p "$VAULT/$(dirname "Index_Maison/Journal_2026-08-16.md")" && cp "$OB/Index_Maison/Journal_2026-08-16.md" "$VAULT/Index_Maison/Journal_2026-08-16.md" && echo OK Index_Maison/Journal_2026-08-16.md
