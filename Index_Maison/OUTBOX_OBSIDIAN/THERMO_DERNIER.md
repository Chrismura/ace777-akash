...
| L/S 1h | 1.052 | crowd |
| BTC 1h/4h/24h | 0.13 / 0.34 / 5.71 % | B7 |
...
- Long/Short 1.052.
- BTC 24h 5.71% · 1h 0.13% · 4h 0.34%.
- Panier alts : 35.0% en baisse (7/20).
- Whales proxy : aucun print ≥500k$ sur les ~500 derniers trades.
- Dark/OTC proxy : taker buy/sell 1.279 · OI 106049.622 (pas de dark pool free temps réel).
- Top traders L/S 1.136.
- Fear & Greed 71 (Greed).
- Market cap crypto ≈ 2.68 T$.
- Alt season proxy : Bitcoin season (BTC.D 58.61%).
- Liquidations 24h proxy ≈ 0.05 B$.
- ETF net inflow : BTC 230.79 M$ (bitbo-public (moy 7j), BTC only).
