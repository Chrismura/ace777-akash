...
> Auto · **sans clé** · sans ordre · 2026-08-22T03:42Z UTC  
...
| L/S 1h | 1.052 | crowd |
| BTC 1h/4h/24h | 0.22 / 0.42 / 5.43 % | B7 |
...
- Long/Short 1.052.
- BTC 24h 5.43% · 1h 0.22% · 4h 0.42%.
- Panier alts : 30.0% en baisse (6/20).
- Whales proxy : aucun print ≥500k$ sur les ~500 derniers trades.
- Dark/OTC proxy : taker buy/sell 1.279 · OI 106026.806 (pas de dark pool free temps réel).
- Top traders L/S 1.136.
- Fear & Greed 71 (Greed).
- Market cap crypto ≈ 2.69 T$.
- Alt season proxy : Bitcoin season (BTC.D 58.53%).
- Liquidations 24h proxy ≈ 0.05 B$.
- ETF net inflow : BTC 230.93 M$ (bitbo-public (moy 7j), BTC only).
- GEX proxy (Deribit) : P/C 0.615 · murC 80000 (+1.7%) · murP 60000 (-23.7%).
- Volumes cachés proxy : taker buy 0.534 · vol perp/spot 12.82×.
- ACE soft: LIVE=MASTER_VORTEX_V2_COLLAB_4H_LIVE_COLOR.log · SKIP=1355 · heat=100.0 · PnL sess=315.8606 · RED=0.
