...
> Auto · **sans clé** · sans ordre · 2026-08-22T00:49Z UTC  
...
| L/S 1h | 1.039 | crowd |
| BTC 1h/4h/24h | -0.65 / 0.41 / 5.51 % | B7 |
...
- Long/Short 1.039.
- BTC 24h 5.51% · 1h -0.65% · 4h 0.41%.
- Panier alts : 35.0% en baisse (7/20).
- Whales proxy : 1 gros print(s) ≥500k$ (max 647140$) — source aggTrades Binance.
- Dark/OTC proxy : taker buy/sell 0.874 · OI 105705.043 (pas de dark pool free temps réel).
- Top traders L/S 1.087.
- Fear & Greed 71 (Greed).
- Market cap crypto ≈ 2.64 T$.
- Alt season proxy : Bitcoin season (BTC.D 58.86%).
- Liquidations 24h proxy ≈ 0.05 B$.
- ETF net inflow : BTC 228.47 M$ (bitbo-public (moy 7j), BTC only).
- GEX proxy (Deribit) : P/C 0.616 · murC 78000 (+0.2%) · murP 60000 (-22.9%).
- Volumes cachés proxy : taker buy 0.534 · vol perp/spot 13.3×.
- ACE soft: LIVE=MASTER_VORTEX_V2_COLLAB_4H_LIVE_COLOR.log · SKIP=1365 · heat=100.0 · PnL sess=302.548 · RED=0.
