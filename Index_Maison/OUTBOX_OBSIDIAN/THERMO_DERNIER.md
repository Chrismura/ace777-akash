...
| L/S 1h | 1.039 | crowd |
| BTC 1h/4h/24h | -0.0 / -0.73 / 5.76 % | B7 |
...
- Long/Short 1.039.
- BTC 24h 5.76% · 1h -0.0% · 4h -0.73%.
- Panier alts : 30.0% en baisse (6/20).
- Whales proxy : aucun print ≥500k$ sur les ~500 derniers trades.
- Dark/OTC proxy : taker buy/sell 0.874 · OI 105695.05 (pas de dark pool free temps réel).
- Top traders L/S 1.085.
- Fear & Greed 71 (Greed).
- Market cap crypto ≈ 2.65 T$.
- Alt season proxy : Bitcoin season (BTC.D 58.84%).
- Liquidations 24h proxy ≈ 0.05 B$.
- ETF net inflow : BTC 228.82 M$ (bitbo-public (moy 7j), BTC only).
