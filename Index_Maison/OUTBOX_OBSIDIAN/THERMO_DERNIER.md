...
| L/S 1h | 1.03 | crowd |
| BTC 1h/4h/24h | -0.22 / -1.62 / 2.33 % | B7 |
...
- Long/Short 1.03.
- BTC 24h 2.33% · 1h -0.22% · 4h -1.62%.
- Panier alts : 15.0% en baisse (3/20).
- Whales proxy : 1 gros print(s) ≥500k$ (max 937182$) — source aggTrades Binance.
- Dark/OTC proxy : taker buy/sell 0.882 · OI 105753.849 (pas de dark pool free temps réel).
