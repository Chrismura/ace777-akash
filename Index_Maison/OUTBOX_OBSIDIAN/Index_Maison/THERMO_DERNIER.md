...
| L/S 1h | 1.03 | crowd |
| BTC 1h/4h/24h | -0.13 / -1.52 / 2.28 % | B7 |
...
- Long/Short 1.03.
- BTC 24h 2.28% · 1h -0.13% · 4h -1.52%.
- Panier alts : 25.0% en baisse (5/20).
- Whales proxy : aucun print ≥500k$ sur les ~500 derniers trades.
- Dark/OTC proxy : taker buy/sell 0.882 · OI 105624.811 (pas de dark pool free temps réel).
- Top traders L/S 1.136.
- Fear & Greed 71 (Greed).
- Market cap crypto ≈ 2.63 T$.
- Alt season proxy : Bitcoin season (BTC.D 58.7%).
- Liquidations 24h proxy ≈ 0.06 B$.
- ETF net inflow : BTC 226.9 M$ (bitbo-public (moy 7j), BTC only).
