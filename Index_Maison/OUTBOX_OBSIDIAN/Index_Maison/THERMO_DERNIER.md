...
| L/S 1h | 1.052 | crowd |
| BTC 1h/4h/24h | -0.09 / 0.11 / 5.17 % | B7 |
...
- Long/Short 1.052.
- BTC 24h 5.17% · 1h -0.09% · 4h 0.11%.
- Panier alts : 30.0% en baisse (6/20).
- Whales proxy : aucun print ≥500k$ sur les ~500 derniers trades.
- Dark/OTC proxy : taker buy/sell 1.279 · OI 105997.046 (pas de dark pool free temps réel).
- Top traders L/S 1.136.
- Fear & Greed 71 (Greed).
- Liquidations 24h proxy ≈ 0.04 B$.
- ETF net inflow : BTC 230.24 M$ (bitbo-public (moy 7j), BTC only).
