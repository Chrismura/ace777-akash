...
> Auto · **sans clé** · sans ordre · 2026-08-22T00:26Z UTC  
...
| L/S 1h | 1.039 | crowd |
| BTC 1h/4h/24h | -0.39 / 0.68 / 5.73 % | B7 |
...
- Long/Short 1.039.
- BTC 24h 5.73% · 1h -0.39% · 4h 0.68%.
- Panier alts : 15.0% en baisse (3/20).
- Whales proxy : 2 gros print(s) ≥500k$ (max 1083224$) — source aggTrades Binance.
- Dark/OTC proxy : taker buy/sell 0.874 · OI 105813.436 (pas de dark pool free temps réel).
- Top traders L/S 1.087.
- Fear & Greed 71 (Greed).
- Market cap crypto ≈ 2.65 T$.
- Alt season proxy : Bitcoin season (BTC.D 58.92%).
- Liquidations 24h proxy ≈ 0.05 B$.
- ETF net inflow : BTC 229.12 M$ (bitbo-public (moy 7j), BTC only).
- GEX proxy (Deribit) : P/C 0.616 · murC 80000 (+2.6%) · murP 60000 (-23.1%).
- Volumes cachés proxy : taker buy 0.534 · vol perp/spot 13.28×.
- ACE soft: LIVE=MASTER_VORTEX_V2_COLLAB_4H_LIVE_COLOR.log · SKIP=1366 · heat=100.0 · PnL sess=302.9919 · RED=0.
