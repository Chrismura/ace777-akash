...
> Auto · **sans clé** · sans ordre · 2026-08-21T22:29Z UTC  
...
| L/S 1h | 1.059 | crowd |
| BTC 1h/4h/24h | -0.04 / 1.74 / 7.88 % | B7 |
...
- Long/Short 1.059.
- BTC 24h 7.88% · 1h -0.04% · 4h 1.74%.
- Panier alts : 15.0% en baisse (3/20).
- Whales proxy : aucun print ≥500k$ sur les ~500 derniers trades.
- Dark/OTC proxy : taker buy/sell 1.482 · OI 106753.694 (pas de dark pool free temps réel).
- Top traders L/S 1.098.
- Fear & Greed 72 (Greed).
- Market cap crypto ≈ 2.66 T$.
- Alt season proxy : Bitcoin season (BTC.D 59.02%).
- Liquidations 24h proxy ≈ 0.05 B$.
- ETF net inflow : BTC 1007.43 M$ (bitbo-public (moy 7j), BTC only).
