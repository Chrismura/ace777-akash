...
| L/S 1h | 1.039 | crowd |
| BTC 1h/4h/24h | -0.65 / 0.42 / 5.71 % | B7 |
...
- Long/Short 1.039.
- BTC 24h 5.71% · 1h -0.65% · 4h 0.42%.
- Panier alts : 35.0% en baisse (7/20).
- Whales proxy : aucun print ≥500k$ sur les ~500 derniers trades.
- Dark/OTC proxy : taker buy/sell 0.874 · OI 105712.933 (pas de dark pool free temps réel).
- Top traders L/S 1.087.
- Fear & Greed 71 (Greed).
- Liquidations 24h proxy ≈ 0.05 B$.
- ETF net inflow : BTC 228.48 M$ (bitbo-public (moy 7j), BTC only).
