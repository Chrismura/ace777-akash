...
| L/S 1h | 1.053 | crowd |
| BTC 1h/4h/24h | -0.36 / 1.5 / 7.01 % | B7 |
...
- Long/Short 1.053.
- BTC 24h 7.01% · 1h -0.36% · 4h 1.5%.
- Panier alts : 15.0% en baisse (3/20).
- Whales proxy : aucun print ≥500k$ sur les ~500 derniers trades.
- Dark/OTC proxy : taker buy/sell 0.948 · OI 106158.459 (pas de dark pool free temps réel).
- Top traders L/S 1.098.
- Fear & Greed 72 (Greed).
- Market cap crypto ≈ 2.65 T$.
- Alt season proxy : Bitcoin season (BTC.D 58.95%).
- Liquidations 24h proxy ≈ 0.05 B$.
- ETF net inflow : BTC 1003.55 M$ (bitbo-public (moy 7j), BTC only).
