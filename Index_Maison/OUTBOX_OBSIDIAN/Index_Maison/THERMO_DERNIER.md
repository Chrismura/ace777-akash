...
| L/S 1h | 1.052 | crowd |
| BTC 1h/4h/24h | -0.07 / 0.13 / 5.47 % | B7 |
...
- Long/Short 1.052.
- BTC 24h 5.47% · 1h -0.07% · 4h 0.13%.
- Panier alts : 35.0% en baisse (7/20).
- Whales proxy : aucun print ≥500k$ sur les ~500 derniers trades.
- Dark/OTC proxy : taker buy/sell 1.279 · OI 106076.776 (pas de dark pool free temps réel).
...
- ACE soft: LIVE=MASTER_VORTEX_V2_COLLAB_4H_LIVE_COLOR.log · SKIP=1398 · heat=100.0 · PnL sess=316.5429 · RED=0.
