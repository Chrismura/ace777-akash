...
> Auto · **sans clé** · sans ordre · 2026-08-21T21:04Z UTC  
...
| L/S 1h | 1.026 | crowd |
| BTC 1h/4h/24h | -0.06 / 0.06 / 6.69 % | B7 |
...
- Long/Short 1.026.
- BTC 24h 6.69% · 1h -0.06% · 4h 0.06%.
- Panier alts : 15.0% en baisse (3/20).
- Whales proxy : aucun print ≥500k$ sur les ~500 derniers trades.
- Dark/OTC proxy : taker buy/sell 1.05 · OI 106047.832 (pas de dark pool free temps réel).
- Top traders L/S 1.085.
- Fear & Greed 72 (Greed).
- Liquidations 24h proxy ≈ 0.04 B$.
- ETF net inflow : BTC 994.42 M$ (bitbo-public (moy 7j), BTC only).
- GEX proxy (Deribit) : P/C 0.614 · murC 78000 (+0.7%) · murP 60000 (-22.5%).
- Volumes cachés proxy : taker buy 0.534 · vol perp/spot 13.26×.
- ACE soft: LIVE=MASTER_VORTEX_V2_COLLAB_4H_LIVE_COLOR.log · SKIP=967 · heat=100.0 · PnL sess=282.5214 · RED=0.
