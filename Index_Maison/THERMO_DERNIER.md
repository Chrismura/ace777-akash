...
> Auto · **sans clé** · sans ordre · 2026-08-21T21:05Z UTC  
...
| L/S 1h | 1.026 | crowd |
| BTC 1h/4h/24h | -0.07 / 0.06 / 6.68 % | B7 |
...
- Long/Short 1.026.
- BTC 24h 6.68% · 1h -0.07% · 4h 0.06%.
- Panier alts : 20.0% en baisse (4/20).
- Whales proxy : aucun print ≥500k$ sur les ~500 derniers trades.
- Dark/OTC proxy : taker buy/sell 1.05 · OI 106042.447 (pas de dark pool free temps réel).
- Top traders L/S 1.085.
- Fear & Greed 72 (Greed).
- Liquidations 24h proxy ≈ 0.04 B$.
- ETF net inflow : BTC 994.22 M$ (bitbo-public (moy 7j), BTC only).
- GEX proxy (Deribit) : P/C 0.614 · murC 78000 (+0.7%) · murP 60000 (-22.5%).
- Volumes cachés proxy : taker buy 0.534 · vol perp/spot 13.26×.
- ACE soft: LIVE=MASTER_VORTEX_V2_COLLAB_4H_LIVE_COLOR.log · SKIP=978 · heat=100.0 · PnL sess=282.6814 · RED=0.
