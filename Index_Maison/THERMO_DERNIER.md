...
> Auto · **sans clé** · sans ordre · 2026-09-06T11:30Z UTC  
...
| L/S 1h | 1.062 | crowd |
| BTC 1h/4h/24h | -0.12 / 0.12 / 0.35 % | B7 |
...
- Long/Short 1.062.
- BTC 24h 0.35% · 1h -0.12% · 4h 0.12%.
- Panier alts : 20.0% en baisse (4/20).
- Whales proxy : 3 gros print(s) ≥500k$ (max 2262988$) — source aggTrades Binance.
- Dark/OTC proxy : taker buy/sell 1.096 · OI 106754.901 (pas de dark pool free temps réel).
- Top traders L/S 1.131.
- Fear & Greed 73 (Greed).
- Market cap crypto ≈ 2.70 T$.
- Alt season proxy : Bitcoin season (BTC.D 59.18%).
- Liquidations 24h proxy ≈ 0.01 B$.
- ETF net inflow : BTC 528.6 M$ (bitbo-public (moy 7j), BTC only).
