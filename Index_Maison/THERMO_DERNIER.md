...
> Auto · **sans clé** · sans ordre · 2026-09-20T20:03Z UTC  
...
- Dark/OTC proxy : taker buy/sell 0.817 · OI 107355.063 (pas de dark pool free temps réel).
- Top traders L/S 1.12.
- Fear & Greed 71 (Greed).
- Market cap crypto ≈ 2.78 T$.
- Alt season proxy : Bitcoin season (BTC.D 58.73%).
- Liquidations 24h proxy ≈ 0.00 B$.
- ETF net inflow : BTC -119.16 M$ (bitbo-public (moy 7j), BTC only).
