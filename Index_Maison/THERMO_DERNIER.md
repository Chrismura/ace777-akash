...
| L/S 1h | 1.039 | crowd |
| BTC 1h/4h/24h | -0.63 / 0.44 / 5.64 % | B7 |
...
- Long/Short 1.039.
- BTC 24h 5.64% · 1h -0.63% · 4h 0.44%.
- Panier alts : 40.0% en baisse (8/20).
- Whales proxy : aucun print ≥500k$ sur les ~500 derniers trades.
- Dark/OTC proxy : taker buy/sell 0.874 · OI 105747.81 (pas de dark pool free temps réel).
- Top traders L/S 1.087.
- Fear & Greed 71 (Greed).
- Market cap crypto ≈ 2.64 T$.
- Alt season proxy : Bitcoin season (BTC.D 58.86%).
- Liquidations 24h proxy ≈ 0.05 B$.
- ETF net inflow : BTC 228.5 M$ (bitbo-public (moy 7j), BTC only).
