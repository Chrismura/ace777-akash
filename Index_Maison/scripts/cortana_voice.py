...
def humanize(text: str) -> str:
    ...
    fr_map = [
        ...
        (r"\bBETA\b", "bêta"),
        (r"\bALPHA\b", "alfa"),
        # Tickers du portefeuille Hulk — prononciation FR propre (sinon Vivienne
        # multilingue bascule de langue → accent espagnol/anglais par moments)
        (r"\bXRPUSDT\b", "X R P dollars"),
        (r"\bHBARUSDT\b", "H bar dollars"),
        (r"\bRIZEUSDT\b", "raïze dollars"),
        (r"\bZBCNUSDT\b", "Z B C N dollars"),
        (r"\bWUSDT\b", "double vé dollars"),
        (r"\bREDUSDT\b", "rède dollars"),
        (r"\bCCUSDT\b", "C C dollars"),
        (r"\bPYTHUSDT\b", "pith dollars"),
        (r"\bRWAINCUSDT\b", "R W A I N C dollars"),
        (r"\bBTCUSDT\b", "bitcoin"),
        (r"\bETHUSDT\b", "éthereum"),
        (r"\bXRP\b", "X R P"),
        (r"\bHBAR\b", "H bar"),
        (r"\bRIZE\b", "raïze"),
        (r"\bZBCN\b", "Z B C N"),
        (r"\bPYTH\b", "pith"),
        (r"\bRWAINC\b", "R W A I N C"),
        (r"\bwins\b", "gains"),
        (r"\blosses\b", "pertes"),
        (r"\bpaper\b", "papier"),
        (r"\bWATCH_PULLBACK\b", "surveillance, repli"),
        (r"\bWATCH\b", "surveillance"),
        (r"\bMEXC\b", "M E X C"),
