...
echo "MaxRelaunch=${NUAGE_WATCHDOG_MAX_RELAUNCH:-5} | INDEX SYNC: ON"
...
# INDEX SYNC ON : on laisse la vraie duo_hunter_phase_barrier du champion (pas de bypass)
