...
**Période:** 2026-07-12T07:21:20Z → 2026-07-12T07:24:36Z (0h03m)
...
**Généré:** 2026-07-12T07:24:38Z UTC
**Filtre session:** `ts >= 2026-07-12T07:21:08Z` (lignes CSV antérieures exclues)
...
| Métrique | Valeur |
|----------|--------|
| **PNL BETA** | **-0.0836 USDT** |
| **PNL ALPHA** | **+0.0000 USDT** |
| **PNL SESSION TOTAL** | **-0.0836 USDT** |
| Statut | `NEGATIF` |
...
| Pertes totales | -0.0836 USDT |
| **PNL net** | **-0.0836 USDT** |
| BPS moyen | -0.86 |

**Meilleur trade:** -0.0836 USDT
**Pire trade:** -0.0836 USDT
