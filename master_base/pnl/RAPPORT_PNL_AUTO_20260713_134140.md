...
**Période:** 2026-07-13T13:31:24Z → 2026-07-13T13:41:30Z (0h10m)
...
**Généré:** 2026-07-13T13:41:40Z UTC
**Filtre session:** `ts >= 2026-07-13T13:31:04Z` (lignes CSV antérieures exclues)
...
| Métrique | Valeur |
|----------|--------|
| **PNL BETA** | **+0.1864 USDT** |
| **PNL ALPHA** | **+0.0000 USDT** |
| **PNL SESSION TOTAL** | **+0.1864 USDT** |
| Statut | `POSITIF` |
...
| Flat (0) | 1 |
| Win rate | **50.0%** |
| Gains totaux | +0.1864 USDT |
| Pertes totales | +0.0000 USDT |
| **PNL net** | **+0.1864 USDT** |
| BPS moyen | 0.94 |

**Meilleur trade:** +0.1864 USDT
