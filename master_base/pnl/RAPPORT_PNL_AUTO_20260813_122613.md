# RAPPORT PNL AUTO — MASTER_BASE_V8_5_IMPACT_4H

**Session:** `MASTER_BASE_V8_5_IMPACT_4H`
**Période:** — → — (—)
...
**Filtre session:** `ts >= 2026-08-13T12:26:10Z` (lignes CSV antérieures exclues)
...
*Rapport auto — CSV: `MASTER_BASE_V8_5_IMPACT_4H_BETA_X5.csv` | `MASTER_BASE_V8_5_IMPACT_4H_ALPHA_X13_BURST13.csv`*
*STATE: `runs/STATE.md`*
